...
CREATE TABLE "Product" (
    ...
    "megaPromo" BOOLEAN NOT NULL DEFAULT false,
    "idv" TEXT,
    "addressStreet" TEXT,
    "addressCity" TEXT,
    "addressState" TEXT,
...
CREATE TABLE "ProductRule" (
    ...
    "text" TEXT NOT NULL,
    "productId" TEXT NOT NULL,
    CONSTRAINT "ProductRule_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
